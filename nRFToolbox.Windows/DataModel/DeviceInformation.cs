...
namespace nRFToolbox
{
	public class DeviceInformationItem : DeviceInformationBase
	{
		...
		//public DeviceInformationItem(GattDeviceService device) 
		//{
		//	this.Device = device;
		//	List<Guid> UUid = new List<Guid>();
		//	UUid.Add(new Guid("00001811-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("0000180f-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001810-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001805-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001818-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001816-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("0000180a-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001800-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001801-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001808-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001809-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("0000180d-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001812-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001802-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001803-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001819-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001807-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("0000180e-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001806-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001814-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001813-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001804-0000-1000-8000-00805f9b34fb"));
		//	UUid.Add(new Guid("00001530-1212-efde-1523-785feabcd123"));
		//	try
		//	{
		//		foreach (var id in UUid)
		//		{
		//			var service = device.GetIncludedServices(id).FirstOrDefault();
		//			if (service != null)
		//			{
