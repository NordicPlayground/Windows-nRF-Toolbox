...
namespace nRFToolbox.UI
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        /// <param name="e">Event receivedBytes describing the conditions that led to the event.</param>
        ...
        /// </summary>
        /// <param name="e">Event receivedBytes that describes how this page was reached.  The Parameter
    ...
    /// <summary>
    /// Class used to hold the event receivedBytes required when a page attempts to load state.
    /// </summary>
    ...
    /// <summary>
    /// Class used to hold the event receivedBytes required when a page attempts to save state.
    /// </summary>
